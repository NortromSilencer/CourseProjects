...
${OBJECTDIR}/sigcan.o: sigcan.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/sigcan.o sigcan.f90

${OBJECTDIR}/etkernel.o: etkernel.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/etkernel.o etkernel.f90

${OBJECTDIR}/efi.o: efi.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/efi.o efi.f90

${OBJECTDIR}/ggubfs.o: ggubfs.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/ggubfs.o ggubfs.f90

${OBJECTDIR}/lambda.o: lambda.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/lambda.o lambda.f90

${OBJECTDIR}/sigsample.o: sigsample.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/sigsample.o sigsample.f90

${OBJECTDIR}/energy.o: energy.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/energy.o energy.f90

${OBJECTDIR}/angles.o: angles.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/angles.o angles.f90

${OBJECTDIR}/valinterp.o: valinterp.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/valinterp.o valinterp.f90

${OBJECTDIR}/locate.o: locate.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/locate.o locate.f90

${OBJECTDIR}/rusroulette.o: rusroulette.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/rusroulette.o rusroulette.f90

${OBJECTDIR}/angdist.o: angdist.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/angdist.o angdist.f90

${OBJECTDIR}/intsqw.o: intsqw.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/intsqw.o intsqw.f90

${OBJECTDIR}/newpos.o: newpos.f90 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/newpos.o newpos.f90
